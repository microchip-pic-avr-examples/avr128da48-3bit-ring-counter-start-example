...
/**
 * \brief Set InputSignal pull mode
 *
 ...
 */
static inline void InputSignal_set_pull_mode(const enum port_pull_mode pull_mode)
{
	PORTA_set_pin_pull_mode(1, pull_mode);
}

/**
 * \brief Set InputSignal data direction
 *
 ...
 *                      (low power state)
 */
static inline void InputSignal_set_dir(const enum port_dir dir)
{
	PORTA_set_pin_dir(1, dir);
}

/**
 * \brief Set InputSignal input/sense configuration
 *
 * Enable/disable InputSignal digital input buffer and pin change interrupt,
 ...
 */
static inline void InputSignal_set_isc(const PORT_ISC_t isc)
{
	PORTA_pin_set_isc(1, isc);
}

/**
 * \brief Set InputSignal inverted mode
 *
 * Enable or disable inverted I/O on a pin
 *
 * \param[in] inverted true  = I/O on InputSignal is inverted
 *                     false = I/O on InputSignal is not inverted
 */
static inline void InputSignal_set_inverted(const bool inverted)
{
	PORTA_pin_set_inverted(1, inverted);
}

/**
 * \brief Set InputSignal level
 *
 ...
 */
static inline void InputSignal_set_level(const bool level)
{
	PORTA_set_pin_level(1, level);
}

/**
 * \brief Toggle output level on InputSignal
 *
 * Toggle the pin level
 */
static inline void InputSignal_toggle_level()
{
	PORTA_toggle_pin_level(1);
}

/**
 * \brief Get level on InputSignal
 *
 * Reads the level on a pin
 */
static inline bool InputSignal_get_level()
{
