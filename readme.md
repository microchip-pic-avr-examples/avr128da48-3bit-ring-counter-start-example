...
![](https://i.imgur.com/JBYbb1x.jpg)

4.	Select the Tool and click Apply.  

![](https://i.imgur.com/5pkBCkF.jpg)
...
![](https://i.imgur.com/Ke0KhGc.jpg)

6.	Click Program and wait for finishing.

![](https://i.imgur.com/sFzQvWG.jpg)
...
![](https://i.imgur.com/JSBMetO.jpg)

5.	Open PINMUX configuration by clicking on![](https://i.imgur.com/NsWtGX3.jpg) icon in the navigation tab, located on the left side of the window.
...
open the **ADD SOFTWARE COMPONENTS** window by clicking![](https://i.imgur.com/7nFD1Ih.jpg) icon.
...
![](https://i.imgur.com/u3L82IZ.jpg)

# Timer B Configuration: 
Timer B is a 16-bit Timer which is configured in a Single Shot Mode and 
it generates a Single pulse which is used as a Clock signal for all the three D flipflops. The output of all the three D-flipflops changes with respective to this clock signal.  Configure the Timer_0 module by following the steps shown in the below figure. 
...
o	Select **Connect user to event channel 3** option from the dropdown menu as event user against the **USERCCLLUT0A: User Channel 3 CCL_LUT0A Input Selection**.
o	Select **Connect user to event channel 3** option from the dropdown menu as event user against the **USERCCLLUT2A: User Channel 3 CCL_LUT2A Input Selection**.
o	Select **Connect user to event channel 3** option from the dropdown menu as event user against the **USERCCLLUT4A: User Channel 3 CCL_LUT4A Input Selection**.
